...
public enum RingGaugeMeterStyle {
    ...
    public struct SemiCircleStyle<V, M> : GaugeStyle where V : View, M : View {
        ...
        public init(trackerSize: Double = 5.0, trackerStyle: StrokeStyle = StrokeStyle(dash:[3.0, 3.0]), needleAnchor: UnitPoint = .center, needleView: @escaping () -> V, valueMarkSize: Double = 10.0, valueMark: @escaping () -> M = { Circle().fill(Color.white) }) {
