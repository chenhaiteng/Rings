...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/chenhaiteng/CoreGraphicsExtension.git", from: "0.5.1"),
        .package(url: "https://github.com/chenhaiteng/ArchimedeanSpiral.git", from: "1.1.1"),
        .package(url: "https://github.com/chenhaiteng/GradientBuilder.git", from: "1.2.1"),
        ...
        .package(url: "https://github.com/chenhaiteng/SwiftClamping", from: "1.1.1")
    ],
    targets: [
