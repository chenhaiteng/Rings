...
//        .package(url: "https://github.com/chenhaiteng/CoreGraphicsExtension.git", from: "0.4.0"),
        .package(url: "https://github.com/chenhaiteng/CoreGraphicsExtension.git", branch: "feature/add-demo-app"),
//        .package(url: "https://github.com/chenhaiteng/ArchimedeanSpiral.git", from: "1.0.12"),
        .package(url: "https://github.com/chenhaiteng/ArchimedeanSpiral.git", branch: "feature/update-to-swift-6.1"),
//        .package(url: "https://github.com/chenhaiteng/GradientBuilder.git", from: "1.0.0"),
        .package(url: "https://github.com/chenhaiteng/GradientBuilder.git", branch: "feature/update-to-swift-6.1"),
...
//        .package(url: "https://github.com/chenhaiteng/SwiftClamping", from: "1.0.0")
        .package(url: "https://github.com/chenhaiteng/SwiftClamping", branch: "feature/update-to-swift-6.1")
    ],
    targets: [
